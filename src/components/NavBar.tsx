  ...
  return (
    <header className="fixed top-0 z-50 w-full bg-base-300">
      <nav className="navbar mx-auto max-w-[1440px] justify-between">
        ...
        <label className="swap-rotate swap md:mr-3">
        ...
        <div className="dropdown-end dropdown ml-3">
          ...
          >
            {sessionData ? (
              <>
              <span className="bg-neutral mx-auto w-full text-center cursor-auto mb-3">¡Hola {sessionData.user.name}!</span>
                <li>
                ...
                <li>
                  <a onClick={sessionData ? () => void signOut() : () => void signIn()}>Cerrar Sesión</a>
                </li>
              </>
            ) : (
              <>
                <li>
                  <a onClick={sessionData ? () => void signOut() : () => void signIn()} className="justify-between">
                    Iniciar Sesión
